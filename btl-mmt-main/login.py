...
class LogIn(object):
    ...
    def setupUi(self, LogIn):
        ...
        self.label.setStyleSheet(
                                "border-image: url(:/image/image/HD.jpg);\n"
    ...
    def retranslateUi(self, LogIn):
        ...
        self.Txtnameapp.setText(_translate("LogIn", "Schrödinger Chat"))
        self.Txthello1.setText(_translate("LogIn", "Welcome to Schrödinger!"))
        self.Txthello2.setText(_translate("LogIn", "A chat app for everyone!"))
    ...
    def signin(self): 
        ...
        if self.Username.text() == "" or self.Password.text() == "":
            ...
            if (response == "Not"):
                ...
                self.LogIn.close()
                call(["python3", "mainchat.py", response, self.Username.text(), serverIP])
